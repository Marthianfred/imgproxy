...
ENV AWS_ACCESS_KEY_ID=QWOFjNJC3foAg6v3K7LT
ENV AWS_SECRET_ACCESS_KEY=Q9X7bAyTXPR5uRffasTt98mftDuUBQdYhohmcSGx
ENV IMGPROXY_USE_S3_FORCE_PATH_STYLE=true
ENV IMGPROXY_ALLOW_UNSAFE_URLS=true
ENV IMGPROXY_SSL_NO_CERT_CHECK=true
ENV IMGPROXY_LOG_LEVEL=debug
ENV IMGPROXY_DEVELOPMENT_ERRORS=true
